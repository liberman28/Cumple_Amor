...
function showDedicationText() {
  ...
  if (!text) {
    text = `¡Feliz cumpleaños, mi amor!\n\nHoy es un día para celebrar todo lo que eres y todo lo bonito que traes a mi vida. En este nuevo año que empiezas, mi mayor deseo es que la vida te devuelva multiplicado cada grano de esfuerzo, de amor y de dedicación que le pones a las cosas.\n\n Deseo que nunca te falte esa fuerza interior que tanto admiro de ti; esa valentía que te hace levantar el mentón y seguir adelante incluso cuando aparecen los bloqueos o el desánimo. Ver cómo te retas a ti misma para ser mejor cada día es una de mis mayores inspiraciones.\n\nTe deseo un año lleno de aprendizajes, de puertas que se abren y de muchísima claridad. Sé lo duro que estás trabajando por tus metas y me emociona enormemente pensar en el futuro, porque tengo la certeza absoluta de que el éxito está esperando por ti y muy pronto lo verás. Tienes el talento, la mente y el corazón para lograr todo lo que te propongas, y ver ese proceso de cerca es un verdadero privilegio para mí.\n\nQue este nuevo año de vida sea el inicio de tu mejor etapa, llena de salud, éxitos y mucha felicidad. Te amo con toda mi alma ¡Feliz cumpleaños!`;
  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Liber";
